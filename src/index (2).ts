...
function getEventLocation(e: UIEvent) {
	switch (typeof (e)) {
		case TouchEvent.toString():
			const te: TouchEvent = e as TouchEvent;
...
// TouchEvent: https://developer.mozilla.org/en-US/docs/Web/API/Touch_events#example
